...
def import_gl_level_2():
    with open('/Users/claytonthompson/Desktop/Data/Django GL and Product CSV/GLLevel2.csv', newline='', encoding='utf-8') as csvfile:
        reader = csv.DictReader(csvfile)
        for row in reader:
...
def import_gl_level_3():
    with open('/Users/claytonthompson/Desktop/Data/Django GL and Product CSV/GLLevel3.csv', newline='', encoding='utf-8') as csvfile:
        reader = csv.DictReader(csvfile)
        for row in reader:
            # Assuming `row` is a dictionary representing a row read from the CSV
            # Clean the BOM from the keys of the row
...
def import_products():
    filepath = '/Users/claytonthompson/Desktop/Data/Django GL and Product CSV/Products.csv'  # Adjust the path as necessary
